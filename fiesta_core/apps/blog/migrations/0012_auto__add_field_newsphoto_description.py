...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsPhoto.description'
        db.add_column(u'blog_newsphoto', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsPhoto.description'
        db.delete_column(u'blog_newsphoto', 'description')
    ...
    models = {
        u'blog.news': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 6, 0, 0)'}),
            ...
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '40', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
