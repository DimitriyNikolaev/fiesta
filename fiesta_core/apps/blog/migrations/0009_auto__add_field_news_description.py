...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blog_news', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'blog_news', 'description')
    ...
    models = {
        u'blog.news': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 0, 0)'}),
