...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.is_archive'
        db.add_column(u'blog_news', 'is_archive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.is_archive'
        db.delete_column(u'blog_news', 'is_archive')
    ...
    models = {
        u'blog.news': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 8, 0, 0)'}),
