...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_news', (
            ...
            ('lang', self.gf('django.db.models.fields.CharField')(default='ru', max_length=2)),
            ...
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 8, 0, 0))),
        ...
        # Adding unique constraint on 'NewsPhoto', fields ['news', 'subnews', 'display_order']
        db.create_unique('blog_newsphoto', ['news_id', 'subnews_id', 'display_order'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'NewsPhoto', fields ['news', 'subnews', 'display_order']
        db.delete_unique('blog_newsphoto', ['news_id', 'subnews_id', 'display_order'])
