...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.city'
        db.add_column('blog_news', 'city',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.city'
        db.delete_column('blog_news', 'city')
    ...
    models = {
        'blog.news': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 19, 0, 0)'}),
